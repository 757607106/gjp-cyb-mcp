...
from tests.billing.test_erp_billing import _billing_toolset, _session
...
def _toolset(tmp_path):
    ...
    api = QueryApi()
    return _billing_toolset(session, api), api
