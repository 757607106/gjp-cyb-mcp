...
def test_masked_auth_outputs_masked_by_default() -> None:
...
def test_masked_auth_strips_duplicate_bearer_masked() -> None:
...
def test_masked_api_key_outputs_masked_by_default() -> None:
...
def test_masked_auth_prefers_authorization_over_api_key() -> None:
