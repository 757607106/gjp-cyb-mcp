...
WORKBUDDY_READ_SCOPE = "yuncyb:read"
WORKBUDDY_WRITE_SCOPE = "yuncyb:write"
...
class WorkBuddyOAuthSettings:
    ...
    def from_env(cls) -> "WorkBuddyOAuthSettings":
        ...
        return cls(
            ...
            connector_source=get_env_value("WORKBUDDY_CONNECTOR_SOURCE", "yuncyb"),
...
<body>
  <main>
    <header>
      <div class="eyebrow">WorkBuddy × YunCYB</div>
      <h1>连接开单能力</h1>
