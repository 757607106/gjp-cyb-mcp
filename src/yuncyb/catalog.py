...
class ProductCatalog:
    ...
    @classmethod
    def from_settings(cls, settings: YunCybSettings) -> "ProductCatalog":
        products = (
...
def _configured_aliases(settings: YunCybSettings) -> dict[str, str]:
...
def _configured_categories(settings: YunCybSettings) -> dict[str, list[str]]:
