...
class YunCybDraft:
    ...
    def business_products_payload(self) -> dict[str, list[dict[str, Any]]]:
        ...
        for line in self.lines:
            if line.status == "matched" and line.product is not None:
                confirmed_products.append(
                    _business_product_fields(line.product, line.order_line),
                )
                continue
            ...
            unmatched_products.append(
                _business_product_fields(None, line.order_line),
            )
