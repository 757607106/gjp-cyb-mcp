...
_EXECUTION_FIELDS_BY_TOOL = {
    ...
    "search_business_references": frozenset({"id", "code"}),
...
def render_yuncyb_result(tool_name: str, result: dict[str, Any]) -> str:
...
def filter_yuncyb_result(tool_name: str, result: dict[str, Any]) -> dict[str, Any]:
...
def present_yuncyb_result(tool_name: str, result: dict[str, Any]) -> tuple[str, dict[str, Any]]:
    return render_yuncyb_result(tool_name, result), filter_yuncyb_result(tool_name, result)


__all__ = ["filter_yuncyb_result", "present_yuncyb_result", "render_yuncyb_result"]
